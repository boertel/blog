...
- ~~[bartender](https://macbartender.com/): $22 for the longest time I could get away by tweaking MacOS preferences in the terminal, but the ability to do so shrink in the last few versions.~~ _Edit (Dec 31, 2024): Bartender got [acquired by an unknown developer](https://www.macrumors.com/2024/06/04/bartender-mac-app-new-owner/) which raised questions about privacy and what they'll be doing with the app. I decided to switch to [Ice](https://github.com/jordanbaird/Ice). I'm just missing the conditional feature to show the battery icon._
